    ...
    <view class="container page-bg fixed-page-large">
        ...
        <view class="content-wrapper">
            <view class="redeem-wrap">
                ...
                <button class="cu-btn green-btn" @click="redeemCoupon">兑换</button>
            </view>
            <view class="coupon_item" v-for="(coupon, index) in couponsList" :key="index">
                <view class="price-wrap">
                    <text class="unit">￥</text>
                    <text class="price">{{ coupon.discount }}</text>
                </view>
                <!-- <view class="tag"><view class="text">新</view></view> -->
                ...
                <view class="info">
                    ...
                    <view class="desc">
                        <view v-if="coupon.effectiveTime">
                            ...
                            <view>限{{ coupon.effectiveTime }}至{{ coupon.expirationTime }}使用</view>
                        </view>
                    </view>
                </view>
                <view class="btn-wrap">
                    <button class="cu-btn btn-bg-red" @click="goToUse" v-if="coupon.used==2">去使用</button>
                </view>
            </view>
            <view class="no-data-text" v-if="!isLoadingComplete && !couponsList.length">加载中...</view>
            <view class="no-data" v-if="isLoadingComplete && !couponsList.length">
        ...
        <view class="buycard" @click="goToBuyCard">
            <view>优惠购券</view>
...
export default {
    ...
    methods: {
     ...
     redeemCoupon() {
        ...
        goToBuyCard(){
            uni.navigateTo({
                 url: '/pages/user/buy-card-voucher/index'
            });
        }
    },
}
...
<style lang="scss">
    ...
    .coupon {
        &_item {
            ...
            margin-bottom: 32upx;
            background: #FFFFFF;
            box-shadow: 0 2px 4px 0 rgba(30,36,43,0.20);
            position: relative;
            border-radius: 16upx;
            overflow: hidden;
            .price-wrap {
